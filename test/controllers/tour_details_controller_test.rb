...
class TourDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour_detail" do
    assert_difference('TourDetail.count') do
      post tour_details_url, params: { tour_detail: { employee_id: @tour_detail.employee_id, end_day: @tour_detail.end_day, place_id: @tour_detail.place_id, start_day: @tour_detail.start_day, tour_id: @tour_detail.tour_id } }
    end
  ...
  test "should update tour_detail" do
    patch tour_detail_url(@tour_detail), params: { tour_detail: { employee_id: @tour_detail.employee_id, end_day: @tour_detail.end_day, place_id: @tour_detail.place_id, start_day: @tour_detail.start_day, tour_id: @tour_detail.tour_id } }
