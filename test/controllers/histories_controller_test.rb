...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { status: @history.status, tour_booking_id: @history.tour_booking_id, user_id: @history.user_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { status: @history.status, tour_booking_id: @history.tour_booking_id, user_id: @history.user_id } }
